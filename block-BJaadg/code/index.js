...
*/
console.log(quote.lastIndexOf('a', lastA - 1));
/*
15. Make the quote 70 character long. If it has less characters add rest as .......
Example: "Hello" (convert to 10 characters) => "Hello....."
Store the output in a new variable
*/
let quoteLong = quote.padEnd(70, "...");
console.log(quoteLong);
/*
16. Do same as (15) but the ... should come in start. Store the output in a new variable
*/
let quoteSmall = quote.padStart(15, "...");
console.log(quoteSmall);
/*
...
*/
console.log(quote.replace("tomorror", "today"));
/*
...
*/
let slice = quote.slice(0, 30);
console.log(slice.concat("..."));
/*
21. Find out does quote, from, to starts with "A"
*/
if(quote.startsWith("A") && to.startsWith("A") && to.startsWith("A")){
  console.log(true);
}
else {
  console.log(false);
